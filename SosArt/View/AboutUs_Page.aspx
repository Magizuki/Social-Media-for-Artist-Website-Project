<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AboutUs_Page.aspx.cs" Inherits="SosArt.View.AboutUs_Page" %>
...
<body style="background-color:black">
    ...
    <div class="container" style="text-align:center">
        <h1 style="color:whitesmoke ; text-align:center">About Us</h1>
        <br />
        <img alt="" src="AboutUs-Content.jpg"  />
        <br />
        <br />
        <br />
        <br />
